...
/**
 * struct wh_mci_pdata - sd/mmc controller platform data
...
/**
 * wh_mci_set_platdata - set platform data for mmc/sdi device
 * @pdata: The platform data
 *
 * Copy the platform data supplied by @pdata so that this can be marked
 * __initdata.
 */
extern void wh_mci_set_platdata(struct wh_mci_pdata *pdata);
